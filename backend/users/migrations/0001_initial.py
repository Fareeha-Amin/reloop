    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('DONOR', 'Donor'), ('ACCEPTOR', 'Acceptor'), ('ADMIN', 'Admin')], default='DONOR', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='acceptor_profile', to=settings.AUTH_USER_MODEL)),
            ],
            options={
